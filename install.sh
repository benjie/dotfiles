...
- fc-cache -fv
- sudo apt install powerline neovim python3-neovim python3-pip curl tmux build-essential tig silversearcher-ag neovim diff-so-fancy ripgrep pipx pspg colordiff xclip pspg postgresql-client-16 git-delta
